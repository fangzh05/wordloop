...
Formal learning uses the single render_lesson_widget with mode=explain, exercise, or feedback. Teach one word at a time. After pronunciation/listening is complete, render the explain card; after the user starts practice, render exercise; after grading and record_attempt, render feedback. Keep semantic grading in ChatGPT, but keep all teaching text and user input in the Widget. Example sentences and exercise prompts must be independent new scenes: never translate, reverse-translate, closely paraphrase, or make a minor noun substitution. Derivation practice, listening practice, long-sentence close, 20-word quizzes, and end-of-session free recall all reuse this same Widget.
